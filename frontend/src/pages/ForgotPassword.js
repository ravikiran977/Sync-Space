...
function ForgotPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage(
        `A reset token has been generated. In a real app, this would be emailed. You can use this token to reset your password.`
      );
  ...
  return (
    <div className="forgot-password-page">
      <div className="forgot-password-card">
        ...
        {message && (
          <p className="forgot-password-alert forgot-password-alert-success">{message}</p>
        )}
